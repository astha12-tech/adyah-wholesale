...
//
//     final consignmentsModel = consignmentsModelFromJson(jsonString);

import 'dart:convert';

ConsignmentsModel consignmentsModelFromJson(String str) =>
    ConsignmentsModel.fromJson(json.decode(str));

String consignmentsModelToJson(ConsignmentsModel data) =>
    json.encode(data.toJson());

class ConsignmentsModel {
  Data? data;
  Meta? meta;
  ...
  factory ConsignmentsModel.fromJson(Map<String, dynamic> json) =>
      ConsignmentsModel(
...
class Consignment {
  ...
  Address? address;
  List<AvailableShippingOption>? availableShippingOptions;
  ...
  factory Consignment.fromJson(Map<String, dynamic> json) => Consignment(
        ...
        selectedShippingOption: json["selected_shipping_option"] == null
            ? null
            : ShippingOption.fromJson(json["selected_shipping_option"]),
        shippingAddress: json["shipping_address"] == null
            ? null
            : Address.fromJson(json["shipping_address"]),
        address:
            json["address"] == null ? null : Address.fromJson(json["address"]),
        availableShippingOptions: json["available_shipping_options"] == null
            ? []
            : List<AvailableShippingOption>.from(
                json["available_shipping_options"]!
                    .map((x) => AvailableShippingOption.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "available_shipping_options": availableShippingOptions == null
            ? []
            : List<dynamic>.from(
                availableShippingOptions!.map((x) => x.toJson())),
      };
}

class AvailableShippingOption {
  String? id;
  String? type;
  String? description;
  String? imageUrl;
  ...
  factory AvailableShippingOption.fromJson(Map<String, dynamic> json) =>
      AvailableShippingOption(
        id: json["id"],
        type: json["type"],
