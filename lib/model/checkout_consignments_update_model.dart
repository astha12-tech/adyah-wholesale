...
//
//     final checkoutConsignmentsUpdateModel = checkoutConsignmentsUpdateModelFromJson(jsonString);

import 'dart:convert';

CheckoutConsignmentsUpdateModel checkoutConsignmentsUpdateModelFromJson(
        String str) =>
    CheckoutConsignmentsUpdateModel.fromJson(json.decode(str));

String checkoutConsignmentsUpdateModelToJson(
        CheckoutConsignmentsUpdateModel data) =>
    json.encode(data.toJson());

class CheckoutConsignmentsUpdateModel {
  Data? data;
  Meta? meta;

  CheckoutConsignmentsUpdateModel({
    this.data,
    this.meta,
  });

  factory CheckoutConsignmentsUpdateModel.fromJson(Map<String, dynamic> json) =>
      CheckoutConsignmentsUpdateModel(
...
class Consignment {
  ...
  factory Consignment.fromJson(Map<String, dynamic> json) => Consignment(
        ...
        availableShippingOptions: json["available_shipping_options"] == null
            ? []
            : List<ShippingOption>.from(json["available_shipping_options"]!
