...
ProductsMainCategoryModel productsMainCategoryModelFromJson(String str) =>
    ProductsMainCategoryModel.fromJson(json.decode(str));

String productsMainCategoryModelToJson(ProductsMainCategoryModel data) =>
    json.encode(data.toJson());

class ProductsMainCategoryModel {
  List<Datum>? data;
  Meta? meta;
  ...
  factory ProductsMainCategoryModel.fromJson(Map<String, dynamic> json) =>
      ProductsMainCategoryModel(
        data: json["data"] == null
            ? []
