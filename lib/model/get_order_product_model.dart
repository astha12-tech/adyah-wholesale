...
GeOrderProductsModel geOrderProductsModelFromJson(String str) =>
    GeOrderProductsModel.fromJson(json.decode(str));

String geOrderProductsModelToJson(GeOrderProductsModel data) =>
...
class GeOrderProductsModel {
  ...
  factory GeOrderProductsModel.fromJson(Map<String, dynamic> json) =>
      GeOrderProductsModel(
        code: json["code"],
        data: json["data"] == null
            ? []
