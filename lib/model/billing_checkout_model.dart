...
//
//     final billingCheckoutModel = billingCheckoutModelFromJson(jsonString);

import 'dart:convert';

BillingCheckoutModel billingCheckoutModelFromJson(String str) => BillingCheckoutModel.fromJson(json.decode(str));

String billingCheckoutModelToJson(BillingCheckoutModel data) => json.encode(data.toJson());
...
class BillingCheckoutModel {
    ...
    factory BillingCheckoutModel.fromJson(Map<String, dynamic> json) => BillingCheckoutModel(
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        consignments: json["consignments"] == null ? [] : List<Consignment>.from(json["consignments"]!.map((x) => Consignment.fromJson(x))),
...
class LineItems {
    ...
    factory LineItems.fromJson(Map<String, dynamic> json) => LineItems(
        physicalItems: json["physical_items"] == null ? [] : List<PhysicalItem>.from(json["physical_items"]!.map((x) => PhysicalItem.fromJson(x))),
        digitalItems: json["digital_items"] == null ? [] : List<dynamic>.from(json["digital_items"]!.map((x) => x)),
        giftCertificates: json["gift_certificates"] == null ? [] : List<dynamic>.from(json["gift_certificates"]!.map((x) => x)),
        customItems: json["custom_items"] == null ? [] : List<dynamic>.from(json["custom_items"]!.map((x) => x)),
    );

    Map<String, dynamic> toJson() => {
        "physical_items": physicalItems == null ? [] : List<dynamic>.from(physicalItems!.map((x) => x.toJson())),
        "digital_items": digitalItems == null ? [] : List<dynamic>.from(digitalItems!.map((x) => x)),
        "gift_certificates": giftCertificates == null ? [] : List<dynamic>.from(giftCertificates!.map((x) => x)),
        "custom_items": customItems == null ? [] : List<dynamic>.from(customItems!.map((x) => x)),
    };
}
...
class Consignment {
    ...
    factory Consignment.fromJson(Map<String, dynamic> json) => Consignment(
        ...
        couponDiscounts: json["coupon_discounts"] == null ? [] : List<dynamic>.from(json["coupon_discounts"]!.map((x) => x)),
        discounts: json["discounts"] == null ? [] : List<dynamic>.from(json["discounts"]!.map((x) => x)),
        lineItemIds: json["line_item_ids"] == null ? [] : List<String>.from(json["line_item_ids"]!.map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "coupon_discounts": couponDiscounts == null ? [] : List<dynamic>.from(couponDiscounts!.map((x) => x)),
        "discounts": discounts == null ? [] : List<dynamic>.from(discounts!.map((x) => x)),
        "line_item_ids": lineItemIds == null ? [] : List<dynamic>.from(lineItemIds!.map((x) => x)),
